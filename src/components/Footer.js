    ...
    <footer className="footer">
      <div className="footer-inner">
        ...
        <div className="footer-brand">
          <Link to="/" className="footer-logo">Asiya Imtiaz</Link>
          <p className="footer-tagline">Designer &amp; Developer</p>
          <p className="footer-copy">© {year} Asiya Imtiaz</p>
        </div>
        ...
        <nav className="footer-nav" aria-label="Footer navigation">
          ...
          {navLinks.map(({ to, label }) => (
            <NavLink key={to} to={to} className="footer-nav-link">
              {label}
            </NavLink>
          ))}
        </nav>
        ...
        <div className="footer-connect">
          ...
          <a href="mailto:asiyaimtiaz03@gmail.com" className="footer-social-link" aria-label="Email">
